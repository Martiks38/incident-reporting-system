...
VALUES
    ("f6e57f24-6f9e-4ac5-bb5d-6eb76d048812", "Maider Gomez", "Email", 2, 14400043),
    ("20184a2c-35bf-427e-aa18-92c4e2a42a07", "Gheorghe Galindo", "Whatsapp", 5, 32400000),
    ("a459b81d-e9f5-41e2-884f-b50e10038a29", "Cesareo Gutierrez", "Email", 1, 14400981),
    ("66d3085f-411c-45f3-9fff-54ea835adb56", "Alejandra Puerta", "Email", 0, null);
...
INSERT INTO `incident-reporting-system`.client
	VALUES
    ('ee9d15b8-c736-42be-901a-13093494d2fe', '34447117969', 'TecnoDynamics Solutions', 3),
    ('f292f337-9a75-4d7e-a4a1-33d888765141', '27729800193', 'Global InnovateTech Services', 1),
    ('71a3a083-afa5-4b87-86a5-535f627818af', '30956149653', 'Quantum Nexus Enterprises', 4);

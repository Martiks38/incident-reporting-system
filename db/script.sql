...
CREATE TABLE IF NOT EXISTS `incident-reporting-system`.`notification_medium` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `medium_UNIQUE` (`medium` ASC) VISIBLE);
...
CREATE TABLE IF NOT EXISTS `incident-reporting-system`.`technical` (
  ...
  INDEX `fk_notification_medium_idx` (`fk_notification_medium` ASC) VISIBLE);
...
CREATE TABLE IF NOT EXISTS `incident-reporting-system`.`client__service` (
  ...
  INDEX `fk_client_has_service_service1_idx` (`fk_cs_service` ASC) VISIBLE,
  INDEX `fk_client_has_service_client_idx` (`fk_cs_client` ASC) VISIBLE);
...
CREATE TABLE IF NOT EXISTS `incident-reporting-system`.`incident__type_problem` (
  ...
  INDEX `fk_incident_has_type_problem_type_problem1_idx` (`fk_ip_type_problem` ASC) VISIBLE,
  INDEX `fk_incident_has_type_problem_incident1_idx` (`fk_ip_incident` ASC) VISIBLE);
...
CREATE TABLE IF NOT EXISTS `incident-reporting-system`.`service__type_problem` (
  ...
  INDEX `fk_service_has_type_problem_type_problem1_idx` (`fk_stp_type_problem` ASC) VISIBLE,
  INDEX `fk_service_has_type_problem_service1_idx` (`fk_stp_service` ASC) VISIBLE);
...
INSERT INTO `incident-reporting-system`.client__service
  VALUES
    ('5138aede-a64c-471b-a6e2-8ac344fb2cd2', 1),
    ('ea1ebab9-55e3-4b68-a0fa-396f64150fb9', 3),
    ('e6327f74-af7d-453f-9d0a-4edcebc9faca', 5);

INSERT INTO `incident-reporting-system`.incident__problem
  VALUES
